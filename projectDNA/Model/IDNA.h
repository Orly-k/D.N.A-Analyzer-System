...
public:
    ...
    virtual SharedPtr<IDNA> operator= (const IDNA* other) = 0;
    virtual SharedPtr<IDNA>operator= (std::string& other) = 0;
    virtual SharedPtr<IDNA> operator= (const char* other) = 0;
    virtual bool operator == (const SharedPtr<IDNA> other) = 0;
    virtual bool operator != (const SharedPtr<IDNA> other) = 0;
